<?php
/*
Plugin Name: UTM Lenses
Description: Copies all full-size images and media in the upload directory into /media at the root folder using AJAX to avoid timeout.
Version: 1.0
Author: Your Name
*/
...
// Exit if domain is not utmlenses.utm.my
